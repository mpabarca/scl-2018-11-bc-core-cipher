...
### Paso a Paso
  ...
  Aquí te mostramos el paso a paso de como utilizar nuestra aplicacion con algunas imágenes y Gif para tener más claridad sobre su uso.

1. Puedes conocer más sobre **Cipher Pass** yendo a nuestra app (link al final del readme). Ahí presentamos en la página de inicio un breve introduccion y si apretas el botón ***COMO FUNCIONA*** podrás aprender un poco más sobre nuestro estilo de cifrado y tambien entender como se usa nuestra app.
![Inicio-Como funciona](https://j.gifs.com/E9DOZ4.gif)

  

2. Si apretas el botón ***COMENZAR A CIFRAR/DESCIFRAR*** podrás usar nuestra aplicación escribiendo una contraseña (sólo letras en mayúscula y sin la Ñ) y una clave de cifrado que nosotros hacemos referencia al día en que usas nuestra aplicacion así te es más fácil comprender nuestro método de cifrado. Haciendo click en ***CIFRAR*** obtines tu nueva contraseña ya cifrada.
Si te olvidaste de cual era la palabra que antes habias ingresado puedes escribir tu nueva contraseña segura con el día en que la creaste, haces click en ***DESCIFRAR*** y listo! Tu antigua contraseña aparece en el cuadro de Resultados.
...
3. También tienes la opcion de Limpiar la página apretando el boton ***LIMPIAR*** y así puedes comenzar nuevamente a usar **Cipher Pass**
...
-----------|-----------|----------|----------|----|
JOSEFA   | Joven de 17 años. Usa a diario Facebook, Instagram, Youtube, entre otras muchas más Redes Sociales|Seguridad y variedad en sus contraseñas  |Una serie de contraseñas seguras para tener en cada red social y asi solo se conectan automáticamente    | Sistema de cifrado para su contraseña común |
ANDREA  | Mujer de 46 años. Se integró hace 2 años a las redes sociales. Actualmente usa sólo facebook y correo de forma diaria y tiene miedo de ser hackeada al entrar al mundo digital| Modo de tener contraseñas seguras y variadas pero teniendo un método fácil para que no sea tan dificil de entender y usar |Crear modo de cifrado para seguridad en contraseñas, diseño de la app fácil de entender | Diseño centrado en un usuario|primerizo en el mundo digital y método de cifrado
